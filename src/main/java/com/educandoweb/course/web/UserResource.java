...
public class UserResource {
    ...
    public ResponseEntity<UserDTO> updateUser(@Valid @RequestBody UserDTO userDTO) {
        ...
        UserDTO result = updatedUser.orElseThrow(() -> new ObjectNotFoundAlertException("userManagement.updated", "User", userDTO.getLogin()));    	
    ...
    public ResponseEntity<UserDTO> getUser(@PathVariable String login) {
        ...
        UserDTO result = userDTO.orElseThrow(() -> new ObjectNotFoundAlertException("wrapOrNotFound", "User", login));    	
    	return ResponseEntity.ok().body(result);
    }
