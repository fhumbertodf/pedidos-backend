...
import com.educandoweb.course.web.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public void saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        Optional<Cliente> existingUser = clienteRepository.findOneByEmailIgnoreCase(userDTO.getEmail());
        ...
        userService.updateUser(userDTO.getLangKey());
    }
