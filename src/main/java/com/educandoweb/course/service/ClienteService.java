...
public class ClienteService {
    ...
    public ClienteService(ClienteRepository clienteRepository, ClienteMapper clienteMapper, ClienteNewMapper clienteNewMapper) {
     ...
     */
    public ClienteDTO insert(ClienteNewDTO clienteDTO) {
